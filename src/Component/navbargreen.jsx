...
const GreenovationNavigationBar = () => {
  ...
  return (
    <nav className="walmart-nav">
      <ul className="walmart-nav-list">
        ...
        <li><Link to="/green" className="walmart-nav-link">Home</Link></li>
        ...
        <li><Link to="/seller" className="walmart-nav-link">Seller</Link></li>
        <li><Link to="/education" className="walmart-nav-link">Educational Section</Link></li>
        <li><Link to="/sustainability" className="walmart-nav-link">Sustainability Reports</Link></li>
      ...
      <div className="walmart-nav-green-btn-container">
        <Link to="/" style={{ textDecoration: 'none' }}>
          <button className="walmart-nav-green-btn">Walmart Zone</button>
        </Link>
      </div>
    </nav>
  );
...
export default GreenovationNavigationBar;
